...
var budgetController = (function() {
    ...
    return {
        addItem: function(type, des, val) { // (id, description, value)
            var newItem;
        ...
        calculateBudget: function() {
            ...
            // calculate income and exp totals
            calculateTotal('exp');
            calculateTotal('inc');

            // calc budget: income minus exp
        ...
        getPercentages: function() {
            var allPercents;
            allPercents = data.allItems.exp.map(function(current) {
...
var UIController = (function() {
    ...
    return {
        getInput: function() {
            return {
                type: document.querySelector(DOMstrings.inputType).value, // income or expense options
        ...
        addListItem: function(obj, type) {
            ...
            // 2. replace placeholder text w some actual data
        ...
        clearFields: function() {
            ...
            // fieldsArr = Array.prototype.slice.call(fields); -----> used for older ES5
